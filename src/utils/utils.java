...
public class utils {
	...
	public static final int MAX_HIERARCHY_NUM = 5; // max layer numbers
	public static final double MAX_ACC_CRI = 1.0;
	public static final double MAX_INACC_CRI = 0.0;
	public static final int BOOSTING_TURNS = 10; // max boosting turns
	public static final double BOOSTING_SAMPLING_POR = 0.7; // sampling proportion
